...
#############################################################################################################
#                                                                                                           #
#           compute_arlac_count.py: update ArLac Monitoring the UV/Ion Shield Health page                   #
#                                                                                                           #
...
import extract_arlac_data        as evd
...
#-----------------------------------------------------------------------------------------
#-- update_arlac_trend_page: update ArLac Monitoring the UV/Ion Shield Health page        --
#-----------------------------------------------------------------------------------------

def update_arlac_trend_page():
    """
    update ArLac Monitoring the UV/Ion Shield Health page
    input:  none, but read from /data/mta4/obs_ss/sot_ocat.out
    output: <html_dir>/arlac_vis_montior.html
    """
#
#--- create calibration arlac observation list and check whether any new observations are added
#
    chk = evd.extract_calb_arlac()
    if chk == 0:
        exit(1)
    else:
#
...
#
#--- call simbad to get arlac location at the observation date
#
    [ra, dec] = fc.find_coordinate('Ar Lac', fyear)
#
...
#
#--- find the difference between ArLac location and the pointing position
#
    detd = dety - dety_p
#
#--- for hrc-s case
